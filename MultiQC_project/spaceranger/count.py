    ...
    for f in module.find_log_files("spaceranger/count_html", filehandles=True):
        ...
        general_stats_data[sample_name] = populate_data_and_headers(
            ...
            new_headers={
                ...
                "Fraction Reads in Squares Under Tissue": "reads in squares",
        ...
        summary_data_by_sample[sample_name] = populate_data_and_headers(
            ...
            new_headers={
                "Number of Reads": "reads",
                "Number of Spots Under Tissue": "spots under tissue",
                "Number of Bins Under Tissue": "bins under tissue",
                ...
                "Median UMIs per Cell": "median umi/cell",
                "Valid Barcodes": "valid bc",
        ...
        try:
            if not plots_conf.get("saturation"):
                if 'analysis_tab' in summary.keys():
                ...
                #        "config": {
                #            "id": "mqc_spaceranger_count_saturation",
                #            "title": f"Space Ranger: count: {summary['tabs']['tab_data'][0]['sequencing_saturation']['sequencing_depth']['inner']['seq_saturation_plot']['title']}",
                #            "xlab": summary['tabs']['tab_data'][0]['sequencing_saturation']['sequencing_depth']['inner']['seq_saturation_plot']['inner']['layout']["xaxis"]["title"],
                #            "ylab": summary['tabs']['tab_data'][0]['sequencing_saturation']['sequencing_depth']['inner']['seq_saturation_plot']['inner']['layout']["yaxis"]["title"],
                #            "ylog": False,
                #            "xlog": False,
                #            "ymin": 0,
                #            "ymax": 1,
                #        },
                #        "description": "Sequencing saturation",
                #        "helptext": summary['tabs']['tab_data'][0]['sequencing_saturation']['sequencing_depth']['inner']['seq_saturation_plot']['title']["helpText"],
                #    }
                #    plots_data["saturation"][sample_name] = transform_data(
                #        summary['tabs']['tab_data'][0]['sequencing_saturation']['sequencing_depth']['inner']['seq_saturation_plot']['inner']['data'][0]
                #    )
